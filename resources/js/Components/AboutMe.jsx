...
export default function AboutMe() {
  return (
    <section className="bg-black text-white py-16 px-6 md:px-20" data-aos="fade-right">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-10">
        ...
        <div className="w-full md:w-2/3 text-center md:text-left">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 relative inline-block">
            About Me
            <span className="block h-[3px] w-16 bg-red-500 mt-2 mx-auto md:mx-0 rounded"></span>
          </h2>
